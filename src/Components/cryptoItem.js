...
export class CryptoItem extends React.Component {
    ...
    DeleteCrypto(e) {
        ...
        axios.delete("http://localhost:4000/api/crypto/" + this.props.crypto._id)
            .then(() => {
                ...
                <Card>
                    <Card.Body>
                        <blockquote className="blockquote">
                            <img src={this.props.crypto.poster} width="150" height="150"></img>
                            <br></br>
                    ...
                    <Link to={"/update/" + this.props.crypto._id} className='btn btn-primary'>Update Crypto</Link>
                    {/* red delete button, goes to server and envokes route point */}
                    <Button variant="danger" onClick={this.DeleteCrypto}>Delete crypto</Button>
                </Card>

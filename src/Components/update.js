...
export class Update extends React.Component {
    ...
    constructor() {
        ...
        componentDidMount(){
            ...
            axios.get('http://localhost:4000/api/crypto/' + this.props.match.params.id)
            .then((res)=>{
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.put('http://localhost:4000/api/crypto/' + this.state._id, newCrypto)
        .then(res =>{
        ...
        return (
            ...
            <div className='Content'>
                ...
                <div className="form-group">
                        <label><b>Update Crypto Title: </b></label>
                    ...
                    <div className="form-group">
                        <label><b>Update Crypto Quantity: </b></label>
                        {/*input maintains its own state and gets updated based on user input can only be updated by using setState() */}
                        <form>
                            <input type='text'
                                id='input'
                    ...
                    <div className="form-group">
                        <label><b>Update Crypto PNG: </b></label>
                        <form>
                            <input type='text'
                                id='input'
                                className='form-input'
